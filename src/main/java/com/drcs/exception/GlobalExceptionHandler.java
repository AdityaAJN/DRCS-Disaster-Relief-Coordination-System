...
/**
 * Enterprise-wide Exception Handler using Aspect-Oriented Programming (AOP).
 * Catches runtime exceptions and formats standardized JSON ApiResponse structures.
 */
